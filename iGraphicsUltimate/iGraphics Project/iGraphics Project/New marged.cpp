...
void iDraw()
{
	...
	iText(356,105,"Use right click to enter your name",(void*)5U);
	}

	else if(k==7)
	{
		iShowBMP(0,0,"astro_bg_5.bmp");
		iText(5,5,"press G to go to back",(void*)5U);

		iText(350,450,ar[0].name,(void*)5U);
		itoa(ar[0].score,play,10);
		iText(500,450,play,(void*)5U);

		iText(350,350,ar[1].name,(void*)5U);
		itoa(ar[1].score,play,10);
		iText(500,350,play,(void*)5U);

		iText(350,250,ar[2].name,(void*)5U);
		itoa(ar[2].score,play,10);
		iText(500,250,play,(void*)5U);

		iText(350,150,ar[3].name,(void*)5U);
		itoa(ar[3].score,play,10);
		iText(500,150,play,(void*)5U);

		iText(350,50,ar[4].name,(void*)5U);
		itoa(ar[4].score,play,10);
		iText(500,50,play,(void*)5U);
